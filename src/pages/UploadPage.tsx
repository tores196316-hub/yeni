  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-8">
      ...
      <div
        ...
        className={`relative cursor-pointer rounded-3xl border-2 border-dashed p-8 md:p-12 text-center transition-all ${
          isDragging
        ...
        <div className="flex flex-col items-center justify-center space-y-4">
          ...
          <div className="space-y-1">
            <p className="text-base font-bold text-white">
              Dosyaları buraya sürükleyin ya da <span className="text-sky-400">Gözatın</span>
            </p>
